...
class weights_walker(object):
    ...
    def __init__(self, path):
        ...
        if path is None: 
            ...
            # NumPy no longer unpacks a 0-d array with a sub-array dtype,
            # so read the 4-int header as a plain 1-D array.
            major, minor, revision, seen = np.memmap(path,
                shape = (4,), mode = 'r', offset = 0,
                dtype = '<i4')
