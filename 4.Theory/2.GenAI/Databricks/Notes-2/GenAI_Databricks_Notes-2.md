...
These capabilities are standard with Databricks Model Serving and AI Gateway for production telemetry and governance. Databricks hosts managed MLflow, where setting your tracking URI to databricks logs traces to your workspace with built-in security, reliability, search, and UI.
